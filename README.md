...
Finally, as a updates to the applicaiton models were made, a new database migration was needed to be generated by envoking `flask db migrate -m "posts table"`:
